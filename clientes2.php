      ...
      <?php while($linha=mysqli_fetch_assoc($resultado)){ ?>
        <tr>
          ...
          <td>
            ...
            <!-- <a  href="inc/controllers/Controller.php?op=excluir&id=<?//$linha['id'];?>" class="btn btn-default">
              <span class="glyphicon glyphicon-trash"></span>
            </a> -->
